...
armoks-blessing
===============
Runs the equivalent of `rejuvenate`, `elevate-physical`, `elevate-mental`,
`elevate-performance`, and `brainwash` on all dwarves currently on the map.
This is an extreme change, which sets every stat and trait to an ideal
easy-to-satisfy preference and optionally legendary skill levels.
...
-- ---------------------------------------------------------------------------
function elevate_performance(unit)
...
function brainwash_unit(unit)
  ...
  unit.status.current_soul.personality.traits.IMAGINATION              = 75 -- was 25
  unit.status.current_soul.personality.traits.ABSTRACT_INCLINED        = 75 -- was 25
  unit.status.current_soul.personality.traits.ART_INCLINED             = 75 -- was 50
...
--  after each need, observations of what takes place in the Inn/Tavern
  unit.status.current_soul.personality.needs:resize(0)
  local list_of_needs={
--  [df.need_type.Socialize]=1, -- socialize, music, stories, poetry, some dancing, need met
--  [df.need_type.BeWithFriends]=2, -- No job
--  [df.need_type.TakeItEasy]=2, -- No job
    [df.need_type.MakeMerry]=2, -- Listen to Music/Story/Poetry and Dancing, need met. ++
--  [df.need_type.Excitement]=2, -- organized singing after combat..
--  [df.need_type.StayOccupied]=2, -- No Job
--  [df.need_type.BeCreative]=2, -- Listen to Music/Story/Poetry and Dancing, no need met?
--  [df.need_type.UpholdTradition]=2, -- No dancing, some No job
--  [df.need_type.ThinkAbstractly]=2, -- bunch up together?
--  [df.need_type.HearEloquence]=2, -- minor listen to story
    [df.need_type.AdmireArt]=2, -- Listen to Story/Poetry/Music, need met. ++
